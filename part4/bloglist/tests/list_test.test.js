...
const { zeroBlogs, oneBlog, manyBlogs } = require('../tests/blog_posts_helper')
...
describe('favoriteBlog', () => {
  ...
  test('when list has one blog, equals to the blog', () => {
  ...
  test('when list has may blogs, equals to the most liked blog', () => {
...
describe('mostBlogs', () => {
  ...
  test('when list has may blogs, equals to the most  blog', () => {
